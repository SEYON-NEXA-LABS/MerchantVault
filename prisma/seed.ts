...
async function main() {
  ...
  const variantsToSeed = [
    // WOLF Oversized T-Shirt variants
    {
      shopifyVariantId: "gid://shopify/ProductVariant/44123456789",
      sku: "TWCT001-BLK-M",
      title: "WOLF Oversized T-Shirt",
      size: "M",
      color: "Black",
